...
## [](#액티비티-상태와-생명주기-콜백)액티비티 상태와 생명주기 콜백
...
![](https://user-images.githubusercontent.com/39554623/120918155-de0ee900-c6ed-11eb-9418-a5885867088c.png)
...
| 존재하지 않음 | 아니오 | 아니오 | 아니오 |
| 중단 | 예 | 아니오 | 아니오 |
| 일시 중지 | 예 | 예(부분적)[\*](#f1) | 아니오 |
| 실행 재개 | 예 | 예 | 예 |

**\*** 당시 상황에 따라 일시 중지된 액티비티의 전체 또는 일부가 사용자에게 보일 수 있다 [↩](#a1)

### [](#존재하지-않음-상태)‘존재하지 않음’ 상태
...
## [](#액티비티-생명주기-로깅하기)액티비티 생명주기 로깅하기

### [](#로그-메세지-만들기)로그 메세지 만들기
...
## [](#액티비티-생명주기가-사용자-액션에-어떻게-응답하는지-살펴보기)액티비티 생명주기가 사용자 액션에 어떻게 응답하는지 살펴보기
...
![](https://user-images.githubusercontent.com/39554623/117337853-da165e00-aed8-11eb-8895-b29343002bc3.png)

### [](#일시적으로-액티비티-떠나기)일시적으로 액티비티 떠나기
...
![](https://user-images.githubusercontent.com/39554623/117338319-64f75880-aed9-11eb-827c-40e26231b683.png)
...
![](https://user-images.githubusercontent.com/39554623/120917949-e31f6880-c6ec-11eb-92fc-48d67fcdc844.png)

#### [](#오버뷰-화면overview-screen에서의-동작은)오버뷰 화면(overview screen)에서의 동작은?

아래의 이미지와 같이 오버뷰 화면의 각 카드는 이전에 사용자가 사용했던 앱을 나타낸다. 오버뷰 화면은 ‘최근 앱 화면’ 또는 '태스크 매니저’라고도 한다. 여기서는 개발자 문서에서 얘기하는 '오버뷰 화면’이라고 칭한다.

![](https://user-images.githubusercontent.com/39554623/117339390-a3d9de00-aeda-11eb-8bda-6c192e189bcf.jpeg)

> 오버뷰 화면에서 태스크 클릭 시에는 `onRestart()`, `onStart()`, `onResume()`이 호출

![](https://user-images.githubusercontent.com/39554623/120918013-30033f00-c6ed-11eb-8379-89b0d5597e8a.png)
...
### [](#다중-창-모드multi-window-mode에서의-동작은)다중 창 모드(multi window mode)에서의 동작은?

![](https://user-images.githubusercontent.com/39554623/117344934-f1594980-aee0-11eb-9168-fd5a8f2c1e9c.jpeg)      ![](https://user-images.githubusercontent.com/39554623/117344937-f28a7680-aee0-11eb-98c1-12a1d8a55482.jpeg)
...
![](https://user-images.githubusercontent.com/39554623/117345504-94aa5e80-aee1-11eb-82dc-e8b98099fd2f.png)
...
![](https://user-images.githubusercontent.com/39554623/117346453-b7894280-aee2-11eb-95b3-f8a4d1cd421b.png)

### [](#액티비티-회전시키기)액티비티 회전시키기

장치를 회전하면 `onPause()`, `onStop()`, `onDestroy()`, `onCreate(…)`, `onStart()`, `onResume()`이 차례로 호출된다.

> 장치 회전 시, MainActivity가 죽었다가 다시 살아난다!

![](https://user-images.githubusercontent.com/39554623/117346682-0800a000-aee3-11eb-87ea-66bf40070494.png)
...
## [](#장치-구성-변경과-액티비티-생명주기)장치 구성 변경과 액티비티 생명주기
...
![](https://user-images.githubusercontent.com/39554623/117349400-4e0b3300-aee6-11eb-8820-2c74137aa9bb.png)

> 방향에 따른 레이아웃이 나온다

  

![](https://user-images.githubusercontent.com/39554623/117349205-14d2c300-aee6-11eb-92b0-52e8d4ca63be.jpeg)      ![](https://user-images.githubusercontent.com/39554623/117349211-169c8680-aee6-11eb-92f5-cf73d17b70c0.jpeg)
