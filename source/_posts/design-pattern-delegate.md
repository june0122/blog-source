---
title: "[디자인 패턴] 위임 패턴(Delegate Pattern)"
date: 2021-08-21T09:06:35.039Z
categories:
  - Design-Pattern
tags:
  - Design Pattern
...
## [](#상속smallinheritancesmall-vs-합성smallcompositionsmall)상속(inheritance) vs 합성(composition)
...
> ### [](#클래스-상속보다는-객체-합성을-선호하라smallfavor-object-composition-over-class-inheritancesmall)클래스 상속보다는 객체 합성을 선호하라(Favor object composition over class inheritance.).
...
## [](#위임smalldelegationsmall)위임(delegation)
...
> Window 클래스가 `area()` 호출을 내부 Rectangle 객체(위임자, delegate)에 위임
...
![](https://user-images.githubusercontent.com/39554623/130242401-6f1987cc-4d37-453d-8601-a9ffd5ff269d.png)
...
### [](#위임을-부분적으로-사용하는-디자인-패턴)위임을 부분적으로 사용하는 디자인 패턴
...
### [](#위임에-전적으로-의존하는-디자인-패턴)위임에 전적으로 의존하는 디자인 패턴
...
-   <Gof의 디자인 패턴> 한국어판 : 상속 대 합성(49p), 위임(51p)
...
#[Design Pattern](/tags/Design-Pattern/)
