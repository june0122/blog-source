---
title: "[코틀린 자료구조] 트리 (Tree)"
date: 2021-07-19T14:36:42.092Z
categories:
  - Data-Structure
tags:
  - Kotlin
...
![](https://user-images.githubusercontent.com/39554623/125863597-4066759b-d019-421a-bcd4-f0383febe0d0.png)
...
## [](#트리와-관련된-용어들smallterminologysmall)트리와 관련된 용어들(Terminology)

### [](#노드smallnodesmall)노드(Node)

연결 리스트와 마찬가지로 트리도 노드로 구성된다.

![](https://user-images.githubusercontent.com/39554623/125863852-f54f02f7-560f-4037-8e11-db6f9ba137b7.png)

각 노드는 일부 데이터를 캡슐화하고 자식을 추적한다.

### [](#부모와-자식smallparent-and-childsmall)부모와 자식(Parent and child)
...
![](https://user-images.githubusercontent.com/39554623/125863863-bf9c778e-92b9-4b93-b44a-edf19b0a64af.png)

### [](#뿌리smallrootsmall)뿌리(Root)

트리의 최상위 노드를 트리의 뿌리(루트, root)라고 한다. 부모가 없는 유일한 노드이기도 하다.

![](https://user-images.githubusercontent.com/39554623/125863874-acebca4c-f298-4ab9-b24e-10376320c968.png)

### [](#잎smallleafsmall)잎(Leaf)

자식이 없는 노드를 리프라고 한다.

![](https://user-images.githubusercontent.com/39554623/125863886-cfebea5d-2c3d-497c-9848-a1c709baa36c.png)
...
![](https://user-images.githubusercontent.com/39554623/125865331-9c19532f-d417-4f64-88f0-91cd4314520f.png)

## [](#traversal-algorithms)Traversal algorithms

배열이나 리스트와 같은 **선형 컬렉션**을 반복(iterating)하는 것은 간단하다. 선형 컬렉션에는 명확한 시작과 끝이 있다.

![](https://user-images.githubusercontent.com/39554623/125865349-410b60ee-2e18-41ea-b07c-05d8f3939925.png)

트리를 반복하는 것은 조금 더 복잡하다.

![](https://user-images.githubusercontent.com/39554623/125865353-3a4a0fec-6f60-42d7-8165-cdee3b7d6ddb.png)
...
### [](#depth-first-traversalsmalldepth-first-search-dfs-깊이-우선-탐색small)Depth-first traversal(Depth-first search, DFS, 깊이 우선 탐색)
...
![](https://user-images.githubusercontent.com/39554623/125865366-20b030f5-3cee-472f-b095-2d50ba7e7151.png)
...
![](https://user-images.githubusercontent.com/39554623/125865372-a74a4353-1568-422f-ac6c-9abf96f4d858.png)
...
![](https://user-images.githubusercontent.com/39554623/126172924-394314ff-9136-4639-bd29-65e1615d6edb.png)
...
1.  레벨 순서 순회를 용이하게 하기 위해 큐를 초기화하는 것으로 시작한다. 또한 새 줄을 출력하기 전에 작업해야하는 노드의 수를 추적하기 위해 _nodesLeftInCurrentLevel_을 만든다.
2.  레벨 순서 순회는 큐가 빌 때까지 계속된다.
3.  첫 번째 while 루프 내에서 _nodesLeftInCurrentLevel_을 큐의 현재 요소로 설정하여 시작한다.
4.  다른 while 루프를 사용하여 _nodesLeftInCurrentLevel_의 수만큼 큐에서 요소를 빼낸다. 큐에서 빼는 모든 요소는 다음 줄로 넘어가지 않고 출력되며, 노드의 모든 자식을 큐에 넣는다.
5.  이 시점에서 `println()`을 사용하여 새 줄을 생성한다. 다음 반복에서 _nodesLeftInCurrentLevel_은 이전 반복의 자식 수를 나타내는 _queue.count_로 업데이트된다.
...
[**_Github에서 본문의 코드 확인하기_**](https://github.com/june0122/DataStructureKotlin/tree/master/src/tree)
...
#[Kotlin](/tags/Kotlin/)[Data Structure](/tags/Data-Structure/)[Tree](/tags/Tree/)
