...
![](https://user-images.githubusercontent.com/39554623/155093468-1e5bc6bb-b56c-435f-9806-e1b1dc9a1769.png)

> Causes the Runnable to be added to the message queue. The runnable will be run on the user interface thread.

"Runnable을 메시지 큐에 추가하여 UI 스레드에서 실행될 수 있게 해준다"라는 설명인데 이것을 더 풀어서 이야기하자면, 다른 스레드에서 핸들러를 통해 메시지(Runnable)를 메시지큐에 추가해서 루퍼를 통해 메인 스레드로 메시지(Runnable)를 넘긴다는 이야기다.
